 ...
 *
 *  TODO Vérification email dans la BDD : Pour que l'utilisateur se connecte à l'aide de son compte existant
 *
 *  TODO Vérification mdp : Concordance entre le password dans la BDD et celui que l'utilisateur à entré à l'aide de la fonction password_verify(motDePasseEntré, motDePasseDansLaBDD);
 *
 *  TODO Lancement d'une session utilisateur (id,username,email)
 *
